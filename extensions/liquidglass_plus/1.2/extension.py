...
_SETTINGS = [
    ...
    },
    {
        "type": "divider",
        "text": (
            "Тип поверхности меняет сам материал: прозрачность, матовость, "
            "преломление и толщину. Свечение и глубина настраиваются отдельно."
        ),
    },
    {
        "type": "action",
...
def on_load(api):
    ...
    _apply_profile()
    api.log("LiquidGlass+ 1.2 loaded")
